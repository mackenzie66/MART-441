...
function showRandomImage(){
    const randomIndex = Math.floor(Math.random() * socialJustice.length);
    const randomImage = socialJustice[randomIndex];
}

  // Update the content on the page
  document.getElementById("image").src = randomImage.imageUrl;
  ...
  document.getElementById("authorAndYear").textContent = `By ${randomImage.author}, ${randomImage.year}`;
